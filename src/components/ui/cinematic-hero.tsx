    ...
    >
      ...
      <div
        ...
        style={{
          ...
          backgroundImage:
            "linear-gradient(to right, rgba(244,239,230,0.04) 1px, transparent 1px), linear-gradient(to bottom, rgba(244,239,230,0.04) 1px, transparent 1px)",
      ...
      <div className="relative z-10 text-center px-6 flex flex-col items-center">
        ...
        <motion.p
          ...
          style={{ color: "rgba(244,239,230,0.55)", fontSize: "clamp(1rem, 2vw, 1.125rem)" }}
        >
        ...
        >
          <a
            ...
            style={{
              ...
              color: "#F4EFE6",
              boxShadow: "0 0 0 1px rgba(0,0,0,0.1), 0 12px 24px -4px rgba(181,96,47,0.5)",
          ...
          <a
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(-3px)"; (e.currentTarget as HTMLElement).style.background = "rgba(244,239,230,0.12)"; }}
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLElement).style.background = "rgba(244,239,230,0.07)"; }}
          >
